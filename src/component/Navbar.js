    ...
    render() {
        return (
            ...
            <Grid container spacing={2} style={{height: 100}}>
                <Grid item xs={6}>
                <div style={{width: 80}}>
                <Link to="/" style={{textDecoration: 'none', color: 'black'}}><h1 style={{marginTop: 20, marginLeft: 38, fontSize: 36, fontWeight: 'bold'}}><i className="fab fa-medium"></i></h1></Link>
                </div>
                </Grid>
                <Grid item xs={6} md={5}>
                <div>
                <Box display="flex" flexDirection="row-reverse" p={1} m={1} bgcolor="background.paper">
                    <Box height="10px">
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={5}>
                            <div style={{paddingLeft: 20, paddingTop: 25}}><Avatar alt="Remy Sharp" src={Other} /></div>
                            </Grid>
                            <Grid item xs={6}>
